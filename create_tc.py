...
if __name__ == '__main__':
    ...
    job = TCCreator()
    # job.rpc_client = TCMS(url=url, username=username, password=password)  # Initialize TCMS client with the URL
    job.rpc_client = TCMS(url, username, password)  # Initialize TCMS client with the URL
